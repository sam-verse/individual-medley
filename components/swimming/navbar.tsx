...
export default function SwimmingNavbar({ onBackToSelection, onBookNowClick }: SwimmingNavbarProps) {
  ...
  const navItems = [
    { 
      name: "Programs", 
      href: "#programs", 
      icon: <Waves className="w-4 h-4 text-sky-500 group-hover:text-sky-600 transition-colors duration-300" />,
      color: "text-sky-600",
      target: "_self"
    },
    { 
    ...
    { 
      name: "Schedule", 
      href: "#schedule", 
      icon: <Calendar className="w-4 h-4 text-sky-500 group-hover:text-amber-600 transition-colors duration-300" />,
