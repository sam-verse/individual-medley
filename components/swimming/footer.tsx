            ...
            <div>
              <div className="flex flex-col items-start sm:flex-row sm:items-center mb-3 gap-2 sm:gap-4">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden flex items-center justify-center ">
                  <img src="/images/fitness-logo.png" alt="Swim Klub Logo" className="w-14 h-14 sm:w-16 sm:h-16 object-contain" />
                </div>
          ...
          <div className="w-full flex flex-col justify-between">
            ...
            <ul className="space-y-4">
              {contactInfo.map((info, idx) => {
                ...
                return (
                  <li key={idx} className="flex items-start gap-3 text-sky-100 text-sm">
                    <Icon className="w-5 h-5 flex-shrink-0 text-cyan-400 mt-0.5" />
                    {info.href ? (
                      <a
                        href={info.href}
