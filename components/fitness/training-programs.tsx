...
import { Zap, Target, Users, Trophy, ArrowRight, Clock, Star } from "lucide-react"
          ...
          {programs.map((program, index) => (
            ...
            >
              ...
              >
                ...
                >
                  <div className="pt-3 md:pt-4 mt-3 md:mt-4 border-t border-blue-800/50">
                    <h4 className="text-xs md:text-sm font-semibold text-blue-300 mb-2">Key Benefits:</h4>
