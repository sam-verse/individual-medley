...
export default function FitnessHero() {
  ...
  useEffect(() => {
    // Split text animation with smoother timing
    if (titleRef.current) {
      ...
      // Animate each character with smoother timing
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-10 items-center max-w-7xl w-full relative z-10 pt-2 md:pt-0">
        <div ref={textRef} className="z-10 text-center md:text-left order-2 md:order-1">
          ...
          <motion.div
            ...
            className="inline-flex items-center px-3.5 py-1.5 bg-blue-900/40 backdrop-blur-sm rounded-full text-blue-300 text-xs font-medium mb-4 md:mb-6 border border-blue-500/20"
          >
          ...
          >
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-white to-blue-300">
              UNLEASH YOUR
            </span>
          ...
          {/* Description - Matches heading animation */}
          <motion.p 
            className="text-sm sm:text-base md:text-lg text-blue-200/90 mb-3 md:mb-6 leading-relaxed max-w-lg mx-auto md:mx-0 px-2 sm:px-0"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.3 }}
          >
